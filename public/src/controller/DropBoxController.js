class DropBoxController{
    ...
    constructor(){
        ...
        // seleciona botão de enviar arquivo
        this.btnSendFileEl = document.querySelector('#btn-send-file');   
        // abre janela para selecionar arquivo
        this.inputFilesEl = document.querySelector('#files');
        // abre barra de progresso do upload
    ...
    connectFirebase(){
        ...
        var firebaseConfig = {
            apiKey: "AIzaSyA4bf_dk0X2Fruifuijo4CxtH2koYpaDgM",
            authDomain: "dropbox-clone-247e3.firebaseapp.com",
            databaseURL: "https://dropbox-clone-247e3.firebaseio.com",
            projectId: "dropbox-clone-247e3",
            storageBucket: "dropbox-clone-247e3.appspot.com",
            messagingSenderId: "221217107703",
            appId: "1:221217107703:web:aabd0084de279db1da6df2",
            measurementId: "G-57G9JYM3M6"
        };
        // Initialize Firebase
    ...
    ajax(url, method = 'GET', formData = new FormData(), onprogress = function(){}, onloadstart = function(){}){
        ...
        return new Promise((resolve, reject) =>{
            let ajax = new XMLHttpRequest();
                ...
                // abrir conexão via POST e vamos mandar para a pasta upload
                ...
                // captura a hora que começou o upload
                onloadstart();
    ...
    uploadTask(files){        
        ...
        // para cada arquivo que recebemos, vamos executar essa função
        [...files].forEach(file=>{   
    ...
    readFiles(){
        ...
        // o firebase vai nos avisar quando algum arquivo for modificado
